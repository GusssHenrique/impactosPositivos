...
<div class="ip-login-wrap">
  ...
  <div class="ip-login-col">
    ...
    <form method="POST" action="/auth/processar_login_unificado.php" novalidate>
      ...
      <div class="ip-forgot">
        <a href="/auth/recuperar_senha.php">Esqueci minha senha</a>
      </div>
  ...
  <div class="ip-register-col">
    ...
    <div class="ip-profile-cards">
      ...
      <a href="/empreendedores/cadastro.php" class="ip-profile-card negocio">
      ...
      <a href="/sociedade_civil/cadastro.php" class="ip-profile-card sociedade">
        <div class="ip-card-icon">
